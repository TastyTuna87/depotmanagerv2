  ...
  return (
    <div className={closeMenu === false ? "sidebar" : "sidebar active"}>
      ...
      >
        ...
        <h2 className="title">Depot Manager</h2>
      </div>
      <div
        className={
      ...
      >
        <ul>
          ...
          <li className={location.pathname === "/assortment" ? "active" : ""}>
            <img src={Settings} alt="assortment" />
            <a href="/assortment">Assortment</a>
          </li>
          <li className={location.pathname === "/nutrition" ? "active" : ""}>
            <img src={Performance} alt="nutrition" />
            <a href="/nutrition">Nutrition</a>
          </li>
          <li className={location.pathname === "/datas" ? "active" : ""}>
            <img src={News} alt="Datas" />
